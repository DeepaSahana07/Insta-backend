...
// Middleware
app.use(cors({
  origin: ['https://insta-frontend-rouge-five.vercel.app', 'https://insta-frontend-4842hjg9g-deepasahana07s-projects.vercel.app', 'http://localhost:3000', 'http://localhost:3001', 'http://localhost:5173'],
  credentials: true,
